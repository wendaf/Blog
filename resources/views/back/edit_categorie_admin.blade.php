                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="form-group col-sm-6">
                                ...
                                @if (File::exists($category['media']))
                                    <img src="/{{$category['media']}}" class="img-reponsive" style="width:300px;" alt="Current Image">
                                @endif
                            </div>
                            <div class="form-group col-sm-6">
                                ...
                                <select name="categorie" id="content_categorie" class="form-control" required>
                                    @foreach ($categoryName as $key => $elem)
                        ...
                        <div class="form-group">
                            ...
                            <input class="form-control" name="name" id="content" type="text" value="{{$category['name']}}" required />
                        </div>
                        <div class="form-group">
