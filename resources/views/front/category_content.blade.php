                ...
                <div class="col-md-12">
                    <div class="widget">
                        <div class="widget_title">
                            <h2><a href="javascript:void(0);">All article from {{$allArticle[0]['categorie'] ?? "Undefined"}}</a></h2>
                        </div>
                        @foreach ($allArticle as $key => $data)
                            <div class="media">
                                <div class="media-left">
                                    <a href="javascript:void(0);"><img class="media-object" src="/{{$data['media']}}" alt="{{$data['title']}}"></a>
                                </div>
